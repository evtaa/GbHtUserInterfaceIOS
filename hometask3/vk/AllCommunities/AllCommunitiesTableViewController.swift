...
class AllCommunitiesTableViewController: UITableViewController {
    ...
    var allCommunities : [Community] = []
       private func generateCommunities () {
           allCommunities = [
            Community (name: "Animals", imageName: "communityAnimals"),
               Community (name: "Robots", imageName: "communityRobots"),
               Community (name: "Programming", imageName: "communityProgramming")]
    }
